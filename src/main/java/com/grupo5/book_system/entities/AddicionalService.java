...
@Setter
@NoArgsConstructor
@Table(name = "tb_addicionalService")
public class AddicionalService implements Serializable {
    @Serial
    ...
    public AddicionalService(Long id, String description, ServiceType serviceType, Double unitPrice,
    ...
    public boolean equals(Object o) {
        ...
        AddicionalService addicionalService = (AddicionalService) o;
        return Objects.equals(id, addicionalService.id);
    }
